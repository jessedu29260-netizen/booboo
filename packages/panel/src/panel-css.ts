...
/* the root rank: departments as columns on one rail, never wrapped */
.oc-row.rank { flex-wrap: nowrap; gap: 18px; padding-top: 10px; }
.oc-row.rank > .oc-child { flex: 0 0 auto; }
